...
module.exports = "\n<h1>Thank you for taking time and stopping by @ <a class=\"nav-link\" [routerLink] =\"['/home']\">MyKathua.com</a> </h1>\n<h2>At mykathua.com, it is all about Kathua.</h2>\n<img src=\"../../assets/images/kth-main.png\" class=\"img-fluid img-thumbnail\" >\n<h3>\nWe are open to ideas and would love to hear from all of you, so get in touch and leave your comments below or write to me <a href=\"mailto:mykathua@@gmail.com\" >mykathua@gmail.com</a>.\n</h3>\n\n<kth-photo></kth-photo>\n<h3>Enjoy your stay at mykathua.com and keep visiting!</h3>\n\n\n\n\n"

/***/ }),

/***/ "./node_modules/raw-loader/index.js!./src/app/music/music.component.html":
/*!**********************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/music/music.component.html ***!
  \**********************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = "<mat-advanced-audio-player [playlist]=\"msaapPlaylist\" [displayTitle]=\"msaapDisplayTitle\" \n            [displayPlaylist]=\"msaapDisplayPlayList\" [pageSizeOptions]=\"msaapPageSizeOptions\" \n                [expanded]=\"true\" [displayVolumeControls]=\"true\"></mat-advanced-audio-player>   "
...
module.exports = "<!-- <h1>Lates local and national news!!</h1>\n{\"id\":1,\n\"title\":\"PM Modi reviews ministries’ performance\",\n\"link\":\"https://www.dailyexcelsior.com/pm-modi-reviews-ministries-performance/\",\n\"postdate\":\"2020-01-05T03:00:59+05:30\",\"abstract\":\"PM Modi reviews ministries’ performance\",\n\"source\":\"DailyExcelsior.com\"} -->\n<div class=\"clr-row\" >\n    <div class=\"clr-col-lg-4 clr-col-md-4 clr-col-sm-4 clr-col-12\" *ngFor=\"let newsItem of news.news.deNews;\">\n<div class=\"card\">\n  \n    <div class=\"card-img\" *ngIf=\"newsItem.imgsrc != '' \">\n        <img src={{newsItem.imgsrc}}>\n    </div>\n    <div class=\"card-block\">\n        <a href={{newsItem.link}} class=\"clickable\">\n            <h4 class=\"card-title\" style=\"color:blue\">{{newsItem.title}}</h4>\n        </a>\n        <p class=\"card-text\"> {{newsItem.abstract}}</p>\n    </div>\n  \n    <div class=\"card-footer\">\n        <span>{{newsItem.source}} | {{newsItem.postdate}}</span>\n     &nbsp;|&nbsp; <span><a href={{newsItem.link}} class=\"card-link\">Read</a></span>\n    </div>\n</div>\n</div>\n</div>\n    <!-- <div class=\"clr-row\" >\n        <div class=\"clr-col-lg-4 clr-col-md-4 clr-col-sm-4 clr-col-12\" *ngFor=\"let newsItem of news.news.deNews;\">\n    <div class=\"card\">\n        <div class=\"card-header\">\n            {{newsItem.title}}\n        </div>\n        <div class=\"card-block\">\n            \n            <div class=\"card-media-block\">\n             \n                <img src={{newsItem.imgsrc}} class=\"card-media-image\" *ngIf=\"newsItem.imgsrc != ''\">\n                <div class=\"card-media-description\">\n                    <span class=\"card-media-title\">\n                       {{newsItem.title}}\n                    </span>\n                    <span class=\"card-media-text\">\n                        {{newsItem.source}} | {{newsItem.postdate}}\n                    </span>\n                </div>\n            </div>\n            <div class=\"card-text\">\n                {{newsItem.abstract}}\n            </div>\n        </div>\n        <div class=\"card-footer\">\n            <button class=\"btn btn-sm btn-link\">Action</button>\n        </div>\n    </div>\n        </div> -->"
...
module.exports = "<div class=\"tweets\">\n    <div class=\"card\" *ngFor=\"let tweet of tweets.tweets.statuses; let i = index\">\n        <i>{{tweet.text}}</i>\n      <app-tweet *ngIf=\"tweet.retweeted_status\" [tweet]=\"tweet.retweeted_status\" [retweet]=\"tweet\" (action)=\"action($event, i)\"></app-tweet>\n      <app-tweet *ngIf=\"!tweet.retweeted_status\" [tweet]=\"tweet\" (action)=\"action($event, i)\"></app-tweet>\n    </div>\n  </div>"

/***/ }),

/***/ "./node_modules/raw-loader/index.js!./src/app/videos/videos.component.html":
/*!************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/videos/videos.component.html ***!
  \************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = "<div class=\"container\"> \n  <div class=\"clr-row\" style=\"background-color: none;\" >\n\n    <div class=\"clr-col-6\" style=\"background-color: none;\" *ngFor=\"let vid of videos;let index = index\" >\n      <!-- <div class=\"card\"> -->\n          <!-- <div class=\"card-header\">#{{index}}-{{vid.snippet.title}}</div> -->\n             \n              <!-- <div class=\"card-block\"> -->\n                  <youtube-player\n                  [videoId]=\"vid.id.videoId\"\n                  (ready)=\"savePlayer($event)\"\n                  (change)=\"onStateChange($event)\"\n                  [playerVars]=\"playerVars\">\n              </youtube-player>\n              <br/>\n              <!-- <span>\n                {{vid.snippet.description}}</span> -->\n              <!-- </div> -->\n              <!-- <div class=\"card-text\">{{vid.snippet.description}}</div> -->\n      <!-- </div> -->\n\n  \n</div>\n  </div> \n\n</div>\n\n\n"

/***/ }),

/***/ "./src/angular-material.module.ts":
/*!****************************************!*\
  !*** ./src/angular-material.module.ts ***!
  \****************************************/
...
/* harmony import */ var _tweets_tweets_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./tweets/tweets.component */ "./src/app/tweets/tweets.component.ts");
/* harmony import */ var _tweets_tweets_resolver__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./tweets/tweets.resolver */ "./src/app/tweets/tweets.resolver.ts");
...
/* harmony import */ var _news_news_resolver__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./news/news.resolver */ "./src/app/news/news.resolver.ts");
...
var routes = [
    ...
    {
        path: 'vid',
        component: _videos_videos_component__WEBPACK_IMPORTED_MODULE_7__["VideosComponent"]
    ...
    },
    {
        ...
        resolve: { news: _news_news_resolver__WEBPACK_IMPORTED_MODULE_11__["NewsResolver"] }
    },
    {
        path: 'music',
        component: _music_music_component__WEBPACK_IMPORTED_MODULE_6__["MusicComponent"]
    },
    {
        path: 'tweets',
        component: _tweets_tweets_component__WEBPACK_IMPORTED_MODULE_8__["TweetsComponent"],
        resolve: { tweets: _tweets_tweets_resolver__WEBPACK_IMPORTED_MODULE_9__["TweetResolver"] }
    }
];
...
/* harmony import */ var ngx_audio_player__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ngx-audio-player */ "./node_modules/ngx-audio-player/fesm5/ngx-audio-player.js");
...
/* harmony import */ var src_angular_material_module__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! src/angular-material.module */ "./src/angular-material.module.ts");
...
/* harmony import */ var _aboutus_aboutus_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./aboutus/aboutus.component */ "./src/app/aboutus/aboutus.component.ts");
...
/* harmony import */ var _music_music_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./music/music.component */ "./src/app/music/music.component.ts");
/* harmony import */ var _videos_videos_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./videos/videos.component */ "./src/app/videos/videos.component.ts");
...
/* harmony import */ var _tweets_tweets_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./tweets/tweets.component */ "./src/app/tweets/tweets.component.ts");
/* harmony import */ var _tweets_tweets_resolver__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./tweets/tweets.resolver */ "./src/app/tweets/tweets.resolver.ts");
/* harmony import */ var src_services_twitter_service__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! src/services/twitter.service */ "./src/services/twitter.service.ts");
/* harmony import */ var _tweet_tweet_component__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./tweet/tweet.component */ "./src/app/tweet/tweet.component.ts");
/* harmony import */ var _tweet_pipe__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./tweet.pipe */ "./src/app/tweet.pipe.ts");
/* harmony import */ var angular2_moment__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! angular2-moment */ "./node_modules/angular2-moment/index.js");
/* harmony import */ var angular2_moment__WEBPACK_IMPORTED_MODULE_25___default = /*#__PURE__*/__webpack_require__.n(angular2_moment__WEBPACK_IMPORTED_MODULE_25__);
/* harmony import */ var _clr_angular__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! @clr/angular */ "./node_modules/@clr/angular/fesm5/clr-angular.js");
/* harmony import */ var _photos_photos_component__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./photos/photos.component */ "./src/app/photos/photos.component.ts");
/* harmony import */ var _news_news_resolver__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ./news/news.resolver */ "./src/app/news/news.resolver.ts");
/* harmony import */ var src_services_news_service__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! src/services/news.service */ "./src/services/news.service.ts");
/* harmony import */ var ngx_youtube_player__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ngx-youtube-player */ "./node_modules/ngx-youtube-player/fesm5/ngx-youtube-player.js");
/* harmony import */ var src_services_youtube_service__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! src/services/youtube.service */ "./src/services/youtube.service.ts");
/* harmony import */ var _videos_youtube_resolver__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! ./videos/youtube.resolver */ "./src/app/videos/youtube.resolver.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            declarations: [
                ...
                _music_music_component__WEBPACK_IMPORTED_MODULE_17__["MusicComponent"],
                _videos_videos_component__WEBPACK_IMPORTED_MODULE_18__["VideosComponent"],
                _contacts_contacts_component__WEBPACK_IMPORTED_MODULE_19__["ContactsComponent"],
                _tweets_tweets_component__WEBPACK_IMPORTED_MODULE_20__["TweetsComponent"],
                _tweet_tweet_component__WEBPACK_IMPORTED_MODULE_23__["TweetComponent"],
                _tweet_pipe__WEBPACK_IMPORTED_MODULE_24__["TweetPipe"],
                _photos_photos_component__WEBPACK_IMPORTED_MODULE_27__["PhotosComponent"]
            ],
            imports: [
                _angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"],
                _app_routing_module__WEBPACK_IMPORTED_MODULE_4__["AppRoutingModule"],
                _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_6__["BrowserAnimationsModule"],
                src_angular_material_module__WEBPACK_IMPORTED_MODULE_12__["MaterialModule"],
                _angular_forms__WEBPACK_IMPORTED_MODULE_8__["FormsModule"],
                _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClientModule"],
                _angular_material_core__WEBPACK_IMPORTED_MODULE_11__["MatNativeDateModule"],
                _angular_forms__WEBPACK_IMPORTED_MODULE_8__["ReactiveFormsModule"],
                angular2_moment__WEBPACK_IMPORTED_MODULE_25__["MomentModule"],
                _clr_angular__WEBPACK_IMPORTED_MODULE_26__["ClarityModule"],
                ngx_audio_player__WEBPACK_IMPORTED_MODULE_9__["NgxAudioPlayerModule"],
                ngx_gallery__WEBPACK_IMPORTED_MODULE_10__["NgxGalleryModule"],
                ngx_youtube_player__WEBPACK_IMPORTED_MODULE_30__["NgxYoutubePlayerModule"].forRoot(),
                angular_bootstrap_md__WEBPACK_IMPORTED_MODULE_7__["MDBBootstrapModule"].forRoot()
            ],
            providers: [_angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"], src_services_twitter_service__WEBPACK_IMPORTED_MODULE_22__["TwitterService"], src_services_youtube_service__WEBPACK_IMPORTED_MODULE_31__["YoutubeService"], src_services_news_service__WEBPACK_IMPORTED_MODULE_29__["NewsService"], _tweets_tweets_resolver__WEBPACK_IMPORTED_MODULE_21__["TweetResolver"], _news_news_resolver__WEBPACK_IMPORTED_MODULE_28__["NewsResolver"], _videos_youtube_resolver__WEBPACK_IMPORTED_MODULE_32__["YoutubeResolver"]],
...
var MusicComponent = /** @class */ (function () {
    function MusicComponent() {
        ...
        this.msaapPlaylist = this.track_list;
    ...
    MusicComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-music',
            template: __webpack_require__(/*! raw-loader!./music.component.html */ "./node_modules/raw-loader/index.js!./src/app/music/music.component.html"),
...
module.exports = ".nav-bar-header{\r\n\r\n    /* background-image: url('/assets/images/kth-main.png') !important; */\r\nmin-height: 100px;\r\n    background-color: rgb(255, 196, 0);\r\n}\r\n\r\n.kth-home{\r\n    color:rgb(255, 145, 0);\r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = ".article-title{\r\n    font-weight: bold;\r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var src_services_news_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/services/news.service */ "./src/services/news.service.ts");



var NewsResolver = /** @class */ (function () {
    function NewsResolver(service) {
    ...
    NewsResolver.ctorParameters = function () { return [
        { type: src_services_news_service__WEBPACK_IMPORTED_MODULE_2__["NewsService"] }
    ]; };
...
var TweetPipe = /** @class */ (function () {
    ...
    TweetPipe.prototype.transform = function (tweet, args) {
        ...
        var text = this.sanitizer.sanitize(_angular_core__WEBPACK_IMPORTED_MODULE_1__["SecurityContext"].HTML, tweet.full_text) || '';
    ...
    TweetPipe.prototype.linking = function (text) {
...
module.exports = ".card-header {\n  padding: 0;\n}\n.card-header .retweeted {\n  font-size: 0.5rem;\n  font-style: italic;\n}\n.card-header .card-header-actions {\n  float: right;\n}\n.card-block {\n  display: grid;\n  grid-template-columns: 1fr 300px;\n  grid-template-rows: 1fr;\n  grid-template-areas: \"text photo\";\n}\n.card-img {\n  grid-area: photo;\n  text-align: right;\n}\n.card-img img {\n  display: inline-block;\n  width: auto;\n  max-width: 300px;\n  max-height: 100px;\n}\n.card-text {\n  grid-area: text;\n}\n::ng-deep .modal-body {\n  text-align: center;\n}\n::ng-deep .modal-body img {\n  max-width: 100%;\n}\n::ng-deep .modal-footer {\n  padding: 0;\n  text-align: left;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3R3ZWV0cy90d2VldHMuY29tcG9uZW50LmNzcyJ9 */"
...
var TweetsComponent = /** @class */ (function () {
    function TweetsComponent(route) {
        this.route = route;
        this.title = 'mykathua tweets!';
        this.inflight = false;
        this.ids = [];
        this.since = '';
    }
...
/***/ "./src/app/tweets/tweets.resolver.ts":
/*!*******************************************!*\
  !*** ./src/app/tweets/tweets.resolver.ts ***!
  \*******************************************/
/*! exports provided: TweetResolver */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TweetResolver", function() { return TweetResolver; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var src_services_twitter_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/services/twitter.service */ "./src/services/twitter.service.ts");



var TweetResolver = /** @class */ (function () {
    function TweetResolver(service) {
        this.service = service;
    }
    TweetResolver.prototype.resolve = function (route, state) {
        return this.service.getTweets();
    };
    TweetResolver.ctorParameters = function () { return [
        { type: src_services_twitter_service__WEBPACK_IMPORTED_MODULE_2__["TwitterService"] }
    ]; };
    TweetResolver = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({ providedIn: 'root' })
    ], TweetResolver);
...
module.exports = "p {\r\n    font-family: Lato;\r\n  }\r\n  .card-header{color:black;font-weight: bold;}\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
var VideosComponent = /** @class */ (function () {
    ...
    VideosComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-videos',
            template: __webpack_require__(/*! raw-loader!./videos.component.html */ "./node_modules/raw-loader/index.js!./src/app/videos/videos.component.html"),
...
/***/ "./src/app/videos/youtube.resolver.ts":
/*!********************************************!*\
  !*** ./src/app/videos/youtube.resolver.ts ***!
  \********************************************/
/*! exports provided: YoutubeResolver */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "YoutubeResolver", function() { return YoutubeResolver; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var src_services_youtube_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/services/youtube.service */ "./src/services/youtube.service.ts");



var YoutubeResolver = /** @class */ (function () {
    function YoutubeResolver(service) {
        this.service = service;
    }
    YoutubeResolver.prototype.resolve = function (route, state) {
        return this.service.getVideos();
    };
    YoutubeResolver.ctorParameters = function () { return [
        { type: src_services_youtube_service__WEBPACK_IMPORTED_MODULE_2__["YoutubeService"] }
    ]; };
    YoutubeResolver = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({ providedIn: 'root' })
    ], YoutubeResolver);
...
module.exports = __webpack_require__(/*! D:\01_git\mykathua\mykathua-app\src\main.ts */"./src/main.ts");
